...
const videos = [
  ...
  { src: 'sautdechat.mp4', title: '6: saut de chat' },
  { src: 'triplette.mp4', title: '7: triplette' },
];
...
playButton.textContent = 'Lire les vidéos sélectionnées';
playButton.addEventListener('click', () => {
  currentVideoIndex = 0;
  playCurrentVideo();
});
videoList.appendChild(playButton); 
